...
mysql_query("INSERT INTO {$_ACCESS_DATABASE_SERVER_DATABASE_TABLE_PREFIX}_application_panels(panel_file_integrity,panel_file_integrity_installation,panel_file_name,panel_alignment,panel_row,panel_file_status,panel_title,panel_timestamp_installation)VALUES('','','Networking','0','4','1','<CENTER><B>Networking</B></CENTER><HR>','$_GLOBAL_LOCAL_SERVER_DATE_TIMESTAMP')");
...
'Unknown :: Race :: 3',
'Unknown :: Race :: 4',
'Hi ! I am the automated Services Account. You cannot Login to this account. There is no Password or Electronic Mail Address On This Account. This is an Automated Services Account that automatically performs Services Root-Level actions set by the Administration. You can however send commands to me to perform or execute a task from either the Administration Control Panel Terminal or by sending an escalated command through the Automated Robot Account.',
'I am Services !',
'$_GLOBAL_LOCAL_SERVER_DATE_TIMESTAMP',
'This Registered Member Account Was Registered From The Internet Protocol Address :: $_GLOBAL_REMOTE_SERVER_ADDRESS On: $_GLOBAL_LOCAL_SERVER_DATE_TIMESTAMP',
'Unknown :: Fingerprint :: Clear-Text',

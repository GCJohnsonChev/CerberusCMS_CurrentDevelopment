...
$_ARCHITECT_LOG_INTERACTION_LOG_FIND_FILE_NAME								= "./Architect/Log/Interaction/Log.txt";
...
fwrite("$_ARCHITECT_LOG_INTERACTION_LOG_OPEN_FILE_NAME", "
Architect :: Activity Log :: Detailed Information
---------------------------------------------------------
Machine and Connection Information :: Non-Registered Visitor
* Architect :: Local Server :: Document View Timestamp: $_GLOBAL_LOCAL_SERVER_DATE_STANDARD
* Architect :: Local Server :: Document Referrer: $_Application_Module_Background_Log_Administrator_GET_REFERRER
* Architect :: User-Agent :: $_Application_Module_Background_Log_Administrator_GET_USER_AGENT
* Architect :: Internet Protocol Address: $_GLOBAL_REMOTE_SERVER_ADDRESS
* Architect :: Remote Server :: Host-Name: $_GLOBAL_REMOTE_SERVER_HOSTNAME
* Architect :: Remote Server :: Port Number: $_GLOBAL_REMOTE_SERVER_PORT
* Architect :: Request String: $_GLOBAL_LOCAL_SERVER_QUERY_STRING

Connection Information
* Architect :: Local Server :: Request Method: $_GLOBAL_LOCAL_SERVER_REQUEST_METHOD
* Architect :: Local Server :: Request Time: $_GLOBAL_LOCAL_SERVER_REQUEST_TIME
* Architect :: Local Server :: Connection Type: $_GLOBAL_LOCAL_SERVER_HTTP_CONNECTION_TYPE

Location Information
* Architect :: Device Location :: By Global-Positioning-System Coordinates:
* Architect :: Device Location :: By Geographical Localization of Objects:
* Architect :: Device Location :: By Region:
* Architect :: Device Location :: By Internet Protocol Address:
...
* Architect :: Digital Fingerprint :: Generated:
...
mysql_query("CREATE TABLE \"$_ARCHITECT_INSTALL_FORM_POST_INSTALL_CREATE_DATABASE_SERVER_DATABASE_NAME_DATABASE_TABLE_PREFIX\"_applications (
...
mysql_query("CREATE TABLE \"$_ARCHITECT_INSTALL_FORM_POST_INSTALL_CREATE_DATABASE_SERVER_DATABASE_NAME_DATABASE_TABLE_PREFIX\"_application_links (
id MEDIUMINT NOT NULL AUTO_INCREMENT,
...
mysql_query("CREATE TABLE \"$_ARCHITECT_INSTALL_FORM_POST_INSTALL_CREATE_DATABASE_SERVER_DATABASE_NAME_DATABASE_TABLE_PREFIX\"_articles (
id MEDIUMINT NOT NULL AUTO_INCREMENT,
...
mysql_query("CREATE TABLE \"$_ARCHITECT_INSTALL_FORM_POST_INSTALL_CREATE_DATABASE_SERVER_DATABASE_NAME_DATABASE_TABLE_PREFIX\"_banned_networks (
id MEDIUMINT NOT NULL AUTO_INCREMENT,
...
settings_system_security_account_restrict_authorization CHAR(1),
...
mysql_query("INSERT INTO {$_ACCESS_DATABASE_SERVER_DATABASE_TABLE_PREFIX}_application_panels(panel_file_integrity,panel_file_integrity_installation,panel_file_name,panel_alignment,panel_row,panel_file_status,panel_title,panel_timestamp_installation)VALUES('','','Applications_Panel','0','1','1','<CENTER><B>Applications Panel</B></CENTER><HR>','$_GLOBAL_LOCAL_SERVER_DATE_TIMESTAMP')");
mysql_query("INSERT INTO {$_ACCESS_DATABASE_SERVER_DATABASE_TABLE_PREFIX}_application_panels(panel_file_integrity,panel_file_integrity_installation,panel_file_name,panel_alignment,panel_row,panel_file_status,panel_title,panel_timestamp_installation)VALUES('','','Banned_Networks','0','4','1','<CENTER><B>Banned Networks</B></CENTER><HR>','$_GLOBAL_LOCAL_SERVER_DATE_TIMESTAMP')");
mysql_query("INSERT INTO {$_ACCESS_DATABASE_SERVER_DATABASE_TABLE_PREFIX}_application_panels(panel_file_integrity,panel_file_integrity_installation,panel_file_name,panel_alignment,panel_row,panel_file_status,panel_title,panel_timestamp_installation)VALUES('','','Project_Badges','1','1','1','<CENTER><B>Project Badges</B></CENTER><HR>','$_GLOBAL_LOCAL_SERVER_DATE_TIMESTAMP')");
mysql_query("INSERT INTO {$_ACCESS_DATABASE_SERVER_DATABASE_TABLE_PREFIX}_application_panels(panel_file_integrity,panel_file_integrity_installation,panel_file_name,panel_alignment,panel_row,panel_file_status,panel_title,panel_timestamp_installation)VALUES('','','Language','1','6','1','<CENTER><B>Set Language</B></CENTER><HR>','$_GLOBAL_LOCAL_SERVER_DATE_TIMESTAMP')");
mysql_query("INSERT INTO {$_ACCESS_DATABASE_SERVER_DATABASE_TABLE_PREFIX}_application_panels(panel_file_integrity,panel_file_integrity_installation,panel_file_name,panel_alignment,panel_row,panel_file_status,panel_title,panel_timestamp_installation)VALUES('','','Latest_Articles','0','3','1','<CENTER><B>Latest Articles</B></CENTER><HR>','$_GLOBAL_LOCAL_SERVER_DATE_TIMESTAMP')");
mysql_query("INSERT INTO {$_ACCESS_DATABASE_SERVER_DATABASE_TABLE_PREFIX}_application_panels(panel_file_integrity,panel_file_integrity_installation,panel_file_name,panel_alignment,panel_row,panel_file_status,panel_title,panel_timestamp_installation)VALUES('','','Latest_Files','1','3','1','<CENTER><B>Latest Files</B></CENTER><HR>','$_GLOBAL_LOCAL_SERVER_DATE_TIMESTAMP')");
mysql_query("INSERT INTO {$_ACCESS_DATABASE_SERVER_DATABASE_TABLE_PREFIX}_application_panels(panel_file_integrity,panel_file_integrity_installation,panel_file_name,panel_alignment,panel_row,panel_file_status,panel_title,panel_timestamp_installation)VALUES('','','Latest_Shouts','1','5','1','<CENTER><B>Latest Shout Messages</B></CENTER><HR>','$_GLOBAL_LOCAL_SERVER_DATE_TIMESTAMP')");
mysql_query("INSERT INTO {$_ACCESS_DATABASE_SERVER_DATABASE_TABLE_PREFIX}_application_panels(panel_file_integrity,panel_file_integrity_installation,panel_file_name,panel_alignment,panel_row,panel_file_status,panel_title,panel_timestamp_installation)VALUES('','','Member_Panel','0','2','1','<CENTER><B>Member Panel</B></CENTER><HR>','$_GLOBAL_LOCAL_SERVER_DATE_TIMESTAMP')");
mysql_query("INSERT INTO {$_ACCESS_DATABASE_SERVER_DATABASE_TABLE_PREFIX}_application_panels(panel_file_integrity,panel_file_integrity_installation,panel_file_name,panel_alignment,panel_row,panel_file_status,panel_title,panel_timestamp_installation)VALUES('','','Latest_Members','1','4','1','<CENTER><B>Newest Members</B></CENTER><HR>','$_GLOBAL_LOCAL_SERVER_DATE_TIMESTAMP')");
mysql_query("INSERT INTO {$_ACCESS_DATABASE_SERVER_DATABASE_TABLE_PREFIX}_application_panels(panel_file_integrity,panel_file_integrity_installation,panel_file_name,panel_alignment,panel_row,panel_file_status,panel_title,panel_timestamp_installation)VALUES('','','RSS_Panel','1','4','1','<CENTER><B>Real-Simple-Syndication</B></CENTER><HR>','$_GLOBAL_LOCAL_SERVER_DATE_TIMESTAMP')");
...
settings_system_security_account_restrict_authorization,
...
statistics_total_number_of_page_views_non_unique,
statistics_total_number_of_page_views_unique,
...
if (unlink("./Architect/MySQL/MySQL_Generator.php") && unlink("./Architect/MySQL/index.php") && unlink("./Architect/index.php") && unlink("./Architect/ToolKit/index.php") && unlink("./Architect/ToolKit/Installation_ToolKit.php") && unlink("./Architect/Log/Interaction/index.php") && unlink("./Architect/Log/Interaction/Log.txt") && unlink("./Architect/Log/Interaction/index.php")) {
...
if (rmdir("./Architect/MySQL/") && rmdir("./Architect/ToolKit/") && rmdir("./Architect/Log/Interaction") && rmdir("./Architect/Log")) {

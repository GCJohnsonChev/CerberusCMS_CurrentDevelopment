...
mysql_query("INSERT INTO {$_ACCESS_DATABASE_SERVER_DATABASE_TABLE_PREFIX}_application_links(application_link_name,application_link_row,application_link_url)VALUES('Download','010','?Application_Member&#61;Download&amp;Display&#61;Torrent')");
mysql_query("INSERT INTO {$_ACCESS_DATABASE_SERVER_DATABASE_TABLE_PREFIX}_application_links(application_link_name,application_link_row,application_link_url)VALUES('Emulators','011','?Application_Member&#61;Emulators&amp;Display&#61;Options')");
mysql_query("INSERT INTO {$_ACCESS_DATABASE_SERVER_DATABASE_TABLE_PREFIX}_application_links(application_link_name,application_link_row,application_link_url)VALUES('Files','012','?Application_Member&#61;Files&amp;CategoryID&#61;All')");
mysql_query("INSERT INTO {$_ACCESS_DATABASE_SERVER_DATABASE_TABLE_PREFIX}_application_links(application_link_name,application_link_row,application_link_url)VALUES('Forum','013','?Application_Member&#61;Forum&amp;ForumID&#61;All')");
mysql_query("INSERT INTO {$_ACCESS_DATABASE_SERVER_DATABASE_TABLE_PREFIX}_application_links(application_link_name,application_link_row,application_link_url)VALUES('Language','014','?Application_Member&#61;Language')");
mysql_query("INSERT INTO {$_ACCESS_DATABASE_SERVER_DATABASE_TABLE_PREFIX}_application_links(application_link_name,application_link_row,application_link_url)VALUES('Lightning Calculate','015','?Application_Member&#61;Lightning_Calculate&amp;Display&#61;Options')");
...
'Hello and welcome to $_PROJECT_STRING_NAME ! If you\'re reading this sentence then $_PROJECT_STRING_NAME was successfully installed to this Web Server !',
'Welcome !',
'$_GLOBAL_LOCAL_SERVER_DATE'
)");
...
if (mail($_ACCESS_ELECTRONIC_MAIL_ADDRESS_SYSTEM_ADMINISTRATOR,"$_PROJECT_STRING_NAME - Testing the Pre-Hyper-Text-Post-Processor Server mail() Function.","
-------This is a test to see if this specific Web Server Pre-Hyper-Text-Post-Processor mail() Function is working-------

-------------------------------------------------------
If you have receieved this Non-Encrypted Electronic Mail Message $_PROJECT_STRING_NAME was installed successfully to your web server through Architect.

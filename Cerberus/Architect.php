...
member_emergency_contact_1 VARCHAR(500),
member_emergency_contact_2 VARCHAR(500),
member_emergency_contact_3 VARCHAR(500),
member_last_referrer TEXT,
member_level_rank CHAR(1),
member_location_device_gps VARCHAR(500),
...
member_physical_ethnicity_1 VARCHAR(500),
member_physical_ethnicity_2 VARCHAR(500),
member_physical_ethnicity_3 VARCHAR(500),
member_physical_ethnicity_4 VARCHAR(500),
member_physical_nationality_1 VARCHAR(500),
member_physical_nationality_2 VARCHAR(500),
member_physical_nationality_3 VARCHAR(500),
member_physical_race_1 VARCHAR(500),
member_physical_race_2 VARCHAR(500),
member_physical_race_3 VARCHAR(500),
member_physical_race_4 VARCHAR(500),
...
'$_GLOBAL_REMOTE_SERVER_ADDRESS',
'$_GLOBAL_REMOTE_SERVER_ADDRESS',
'Empty Entry :: Emergency Contact :: 1',
'Empty Entry :: Emergency Contact :: 2',
...
'2465',
'380',
'Hi ! My name is Cerberus ! I am the automated Services Root Administrator Account. You can send commands to me from any Registered Administrator Account. You can Login to my account by using your Administrator Password with Electronic Mail Address: Cerberus@Local.host',

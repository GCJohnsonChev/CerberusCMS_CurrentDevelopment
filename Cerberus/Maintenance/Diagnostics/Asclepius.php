...
/*
 ...
 +
 + ---
 + - File Location: Master Root Directory->Root Directory->Maintenance->Diagnostics->Asclepius.php
...
echo ("
		<FORM ACTION=\"../../$_INTERNAL_FILE_KERNEL?$_INTERNAL_APPLICATION_MODULE_INTERNAL&#61;Login\" METHOD=\"POST\">
			...
			Try Using The Member Account UserName: <I>'$_PROJECT_STRING_NAME_SHORT'</I> With Original Administration Password<BR><BR>

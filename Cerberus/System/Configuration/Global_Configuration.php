...
/*
 ============================================================================================================
 + Application Module Variables :: Administration, Custom, Member, Public and Internal
 ============================================================================================================
*/

/*
 * For an additional security layer you can change the values of the invokable Application Module variables
 * shown here to a completely random string generated by a random string variable. This will make it impossible
 * for an attacker to know the next string generated in the URL once the page executes again thereby making
 * it impossible for any Cross-Site-Request GET and POST forgery or data tampering.
 */

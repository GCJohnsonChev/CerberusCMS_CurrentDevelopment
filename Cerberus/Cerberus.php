...
/*
 ============================================================================================================
 + Global System Settings: Security Application Modules
 ============================================================================================================
*/

$_GLOBAL_SYSTEM_SECURITY_MODULE_DIRECTORY_SANITIZATION					= $_DB_Query_Kernel_Settings_Fetch_Array['settings_system_security_module_directory_sanitization'];
$_GLOBAL_SYSTEM_SECURITY_MODULE_STATUS_SANITIZATION					= $_DB_Query_Kernel_Settings_Fetch_Array['settings_system_security_module_status_sanitization'];

/*
 ============================================================================================================
 + Global System Settings: Security Application Modules :: Master Sanitization
 ============================================================================================================
*/
...
/*
 ============================================================================================================
 + Global Member Settings :: Variables :: Web Browser :: Current
 ============================================================================================================
*/
...
/*
 ============================================================================================================
 + Global Member Settings :: Variables :: Web Browser :: Authorized
 ============================================================================================================
*/
...
/*
 ============================================================================================================
 + Global Member Settings :: Variables :: MAC Address :: Current
 ============================================================================================================
*/
...
/*
 ============================================================================================================
 + Global Member Settings :: Variables :: MAC Address :: Authorized
 ============================================================================================================
*/
...
/*
 ============================================================================================================
 + Global Member Settings :: Variables :: Referrer :: Last Known Referrer
 ============================================================================================================
*/
...
/*
 ============================================================================================================
 + Global Member Settings :: Variables :: Number of Posts
 ============================================================================================================
*/
...
/*
 ============================================================================================================
 + Global Member Settings :: Variables :: Internet Protocol Address :: Current
 ============================================================================================================
*/
...
/*
 ============================================================================================================
 + Global Member Settings :: Variables :: Internet Protocol Address :: Last Authentication
 ============================================================================================================
*/
...
/*
 ============================================================================================================
 + Global Member Settings :: Variables :: Security :: Digital Fingerprint
 ============================================================================================================
*/
...
/*
 ============================================================================================================
 + Global Member Settings :: Variables :: Security :: Setting :: Flag :: Force Logout
 ============================================================================================================
*/
...
/*
 ============================================================================================================
 + IF: Registered Member Account Banned Status Is Active, Redirect To The Banned Message ( 1 )
 ============================================================================================================
*/
...
* Device :: Location :: From H.T.M.L. 5 :: Global-Positioning-Coordinates In X ::
* Device :: Location :: From H.T.M.L. 5 :: Global-Positioning-Coordinates In Y ::
...
$_DB_Query_Kernel_Login_Set_Member_Status_Account_IP_Address_Last_Authentication_Server_Local	= $DB->query("UPDATE {$_ACCESS_DATABASE_SERVER_DATABASE_TABLE_PREFIX}_members SET member_ip_address_last_authentication_server_local='$_GLOBAL_REMOTE_SERVER_ADDRESS' WHERE member_username='$_Kernel_Authenticate_Member_Account_POST_USERNAME_CLEAR'");
...
/*
 ============================================================================================================
 +
 + Internal Security :: Member Account :: Session :: Web Browser
 +
 ============================================================================================================
*/
...
/*
 ============================================================================================================
 +
 + Internal Security :: Member Account :: Session :: MAC Address
 +
 ============================================================================================================
*/
...
/*
 ============================================================================================================
 +
 + Internal Security :: Member Account :: Session :: Force Logout
 +
 ============================================================================================================
*/
...
**/
	...
	header("Location: ?$_INTERNAL_APPLICATION_MODULE_INTERNAL=Logout"); // Fake Data In Cookies Found - Redirect To Logout Section, Destroy All Cookies

} // [ + ] IF: Database Server Query :: Check The Registered Member Account Data In The Browser Cookies AND Compare That Data To The Registered Member Account Database Server Entry
...
} // [ + ] IF: Check :: Registered Member Account Credentials
...
if (substr_count($_GLOBAL_LOCAL_SERVER_HTTP_USER_AGENT_DISPLAY,"<") == 1) {
...
} // [ + ] IF: GZIP Compression Is On: Set Display GZIP Status Variable
...
/*
 ...
 +
 +
 + [ @ ] Application Modules :: Registered Member Account-Level AND Non-Registered Member Account Vistor-Level
 +
 +
 ============================================================================================================
*/
...
$_KERNEL_APPLICATION_MODULE_MEMBER_FILE_INTEGRITY					= $_DB_Query_Kernel_Select_Applications_Fetch_Array['application_file_integrity'];
$_KERNEL_APPLICATION_MODULE_MEMBER_FILE_INTEGRITY_INSTALLATION				= $_DB_Query_Kernel_Select_Applications_Fetch_Array['application_file_integrity_installation'];
$_KERNEL_APPLICATION_MODULE_MEMBER_FILE_NAME						= $_DB_Query_Kernel_Select_Applications_Fetch_Array['application_file_name'];
$_KERNEL_APPLICATION_MODULE_MEMBER_FILE_PERMISSION					= $_DB_Query_Kernel_Select_Applications_Fetch_Array['application_file_permission'];
$_KERNEL_APPLICATION_MODULE_MEMBER_FILE_PERMISSION_CAMERA				= $_DB_Query_Kernel_Select_Applications_Fetch_Array['application_file_permission_camera'];
$_KERNEL_APPLICATION_MODULE_MEMBER_FILE_PERMISSION_MICROPHONE				= $_DB_Query_Kernel_Select_Applications_Fetch_Array['application_file_permission_microphone'];
$_KERNEL_APPLICATION_MODULE_MEMBER_FILE_PERMISSION_LOCATION_GPS				= $_DB_Query_Kernel_Select_Applications_Fetch_Array['application_file_permission_location_gps'];
$_KERNEL_APPLICATION_MODULE_MEMBER_FILE_PERMISSION_LOCATION_GLO				= $_DB_Query_Kernel_Select_Applications_Fetch_Array['application_file_permission_location_glo'];
$_KERNEL_APPLICATION_MODULE_MEMBER_FILE_PERMISSION_LOCATION_INTERNET_PROTOCOL_ADDRESS	= $_DB_Query_Kernel_Select_Applications_Fetch_Array['application_file_permission_location_internet_protocol_address'];
$_KERNEL_APPLICATION_MODULE_MEMBER_FILE_STATUS						= $_DB_Query_Kernel_Select_Applications_Fetch_Array['application_file_status'];
$_KERNEL_APPLICATION_MODULE_MEMBER_FILE_TIMESTAMP_INSTALLATION				= $_DB_Query_Kernel_Select_Applications_Fetch_Array['application_file_timestamp_installation'];
...
} // [ + ] IF: Application Module :: Member :: Access Level Permission Is: Open

/*
 ============================================================================================================
 + IF: Application Module Permission Is: Registered Member Account-Level ( Open )
 ============================================================================================================
*/
...
} // [ + ] IF: Application Module :: Member :: Access Level Permission Is: Registered Member Account-Level
...
} // [ + ] IF: Registered Member Account :: Credentials :: Is Administrator: Include Administration Application Module

} // [ + ] IF: Permission :: Application Module Is: 2, Administrator

} else {

	echo ($_Message_Kernel_APPLICATION_DEACTIVATED);

} // [ + ] IF: Application Module Status Is: Activated OR Deactivated

} else {

	echo ($_Message_Kernel_APPLICATION_NOT_FOUND);

} // [ + ] IF: File Exists :: Application Module File

} // [ + ] IF: Internal Application: Display Application Module Is: Activated
...
/*
 ...
 +
 +
 + Internal Resources :: Network Connections :: Close Visitor and Registered Member Connections
 +
 +
 ============================================================================================================
*/

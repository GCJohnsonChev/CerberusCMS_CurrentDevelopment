...
$_GLOBAL_COOKIE_MEMBER_SESSION								= $_COOKIE['kernel_member_string_session'];
...
echo ("Checking UserName, Electronic Mail Address and Password: $_Kernel_Authenticate_Member_Account_POST_USERNAME_CLEAR $_Kernel_Authenticate_Member_Account_POST_PASSWORD_CLEAR $_Kernel_Authenticate_Member_Account_POST_ELECTRONIC_MAIL_ADDRESS_CLEAR<BR><BR>");
...
echo ("Throwing DB->Fetch_Array Query<BR>");

...
if ($_GET["$_INTERNAL_APPLICATION_MODULE_INTERNAL"] == "Language") {
	...
	$_KERNEL_POST_SPECIFY_LANGUAGE	 							= $_POST['IAM_Set_Language'];
...
$_GLOBAL_SECURITY_MEMBER_FINGERPRINT							= "$_GLOBAL_COOKIE_MEMBER_USERNAME ::: $_GLOBAL_SECURITY_MEMBER_FINGERPRINT_STRING_REMOTE_SERVER_ADDRESS ::: $_GLOBAL_REMOTE_SERVER_HTTP_USER_AGENT_DISPLAY ::: $_GLOBAL_SECURITY_MEMBER_FINGERPRINT_STRING_LENGTH_REMOTE_SERVER_ADDRESS ::: $_GLOBAL_SECURITY_MEMBER_FINGERPRINT_STRING_LENGTH_MEMBER_USERNAME ::: $_GLOBAL_SECURITY_MEMBER_FINGERPRINT_STRING_LENGTH_MEMBER_PASSWORD ::: $_GLOBAL_SECURITY_MEMBER_FINGERPRINT_STRING_DATE_TIME ::: $_GLOBAL_SYSTEM_SECURITY_RANDOM_STRING_GENERATOR_LENGTH_NUMBER_HASH";

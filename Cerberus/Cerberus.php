...
$_GLOBAL_SYSTEM_SAFEHTML_DIRECTORY						= $_DB_Query_Kernel_Settings_Fetch_Array['settings_system_plugin_directory_safeHTML'];
$_GLOBAL_SYSTEM_SAFEHTML_STATUS							= $_DB_Query_Kernel_Settings_Fetch_Array['settings_system_plugin_status_safeHTML'];
...
$_GLOBAL_SYSTEM_TEXT_EDITOR_DIRECTORY						= $_DB_Query_Kernel_Settings_Fetch_Array['settings_system_plugin_directory_text_editor'];
$_GLOBAL_SYSTEM_TEXT_EDITOR_STATUS						= $_DB_Query_Kernel_Settings_Fetch_Array['settings_system_plugin_status_text_editor'];
...
if (password_verify($_POST_LOGIN_PASSWORD_CLEAR, $DB_Query_Kernel_Check_Member_Account_Credentials_Member_Password)) {
...
$_Kernel_Member_Account_Authentication_Log_OPEN_FILE_NAME				= fopen("./Member/$_POST_LOGIN_USERNAME_CLEAR/Files/Document/Activity_Logging/Authentication_Log.php", "a");
...
---------------------------------------------------------------------------------------
Kernel Message: 
The Member Account: $_POST_LOGIN_USERNAME_CLEAR Successfully Authenticated
---------------------------------------------------------------------------------------
* Member Account UserName: $_POST_LOGIN_USERNAME_CLEAR
...
$_DB_Query_Kernel_Login_Set_Member_Status_Account_Last_Login				= $DB->query("UPDATE {$_ACCESS_DATABASE_SERVER_DATABASE_TABLE_PREFIX}_members SET member_ip_address_last_login='$_GLOBAL_REMOTE_SERVER_ADDRESS' WHERE member_username='$_POST_LOGIN_USERNAME_CLEAR'");
$_DB_Query_Kernel_Login_Set_Member_Status_Account_Active				= $DB->query("UPDATE {$_ACCESS_DATABASE_SERVER_DATABASE_TABLE_PREFIX}_members SET member_status_account_active='1' WHERE member_username='$_POST_LOGIN_USERNAME_CLEAR'");
...
if ($_GLOBAL_SYSTEM_SAFEHTML_STATUS >= 1) {
	...
	$_GLOBAL_PLUGIN_SAFEHTML_LIST_COMMANDS					= "<CENTER>The Safe-HTML Plug-In Application Module Is: Deactivated</CENTER>";

} // [ + ] IF: Safe-HTML Code Status Is: On or Off

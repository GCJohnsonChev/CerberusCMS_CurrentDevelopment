...
/*
 ...
 +
 + ---
 + - File Location: Master Root Directory->Root Directory->Cerberus.php
...
$_KERNEL_LOGIN_USERNAME_CLEAR								= strtolower($_KERNEL_LOGIN_USERNAME_CLEAR);
$_KERNEL_LOGIN_USERNAME_CLEAR								= ucfirst($_KERNEL_LOGIN_USERNAME_CLEAR);
...
$DB_Query_Kernel_Check_Member_Account_Credentials_Member_Status_Account_Locked		= $DB_Query_Kernel_Check_Member_Account_Credentials_Fetch_Array['member_status_account_locked'];
$DB_Query_Kernel_Check_Member_Account_Credentials_Member_Attempt_Authentication		= $DB_Query_Kernel_Check_Member_Account_Credentials_Fetch_Array['member_attempt_authentication'];
...
if ($DB_Query_Kernel_Check_Member_Account_Credentials_Member_Status_Account_Locked > "0") {
...
if ($DB_Query_Kernel_Check_Member_Account_Credentials_Member_Attempt_Authentication >= "5") {
...
---------------------------------------------------------------------------------------
Kernel Message: 
The Member Account: $_KERNEL_LOGIN_USERNAME_CLEAR Failed To Authenticate
---------------------------------------------------------------------------------------
* Member Account UserName: $_KERNEL_LOGIN_USERNAME_CLEAR
* Member Account Password: ****************************
* Remote Server Internet Protocol Address: $_GLOBAL_REMOTE_SERVER_ADDRESS
...
$_Kernel_Check_Member_Account_Credentials_Increment_Member_Attempt_Authentication	= $DB_Query_Kernel_Check_Member_Account_Credentials_Member_Attempt_Authentication + 1;
$DB_Query_Kernel_Member_Account_Update_Attempt_Authentication				= $DB->query("UPDATE {$_ACCESS_DATABASE_SERVER_DATABASE_TABLE_PREFIX}_members SET member_attempt_authentication='$_Kernel_Check_Member_Account_Credentials_Increment_Member_Attempt_Authentication' WHERE member_username='$_KERNEL_LOGIN_USERNAME_CLEAR'");

...
if (file_exists($_GLOBAL_SYSTEM_CONFIGURATION_FILE)) {
	...
	include_once "$_GLOBAL_SYSTEM_CONFIGURATION_FILE";
			...
			echo ("Kernel Message: Error: System Configuration File Missing: $_GLOBAL_SYSTEM_CONFIGURATION_FILE | <A HREF=\"./Maintenance/Diagnostics/Diagnose.php\" TITLE=\":: $_PROJECT_STRING_NAME_EXTENDED :: Diagnostics Application ::\" TARGET=\"_NEW\">Please Click Here For Extensive Diagnostics</A>");
...
/*
 ============================================================================================================
 + Global Member Cookie Variables :: Member Account :: Member String :: Session
 ============================================================================================================
*/

$_GLOBAL_COOKIE_MEMBER_SESSION								= $_COOKIE['kernel_member_security_string_session'];
...
$DB_Query_Kernel_Authenticate_Check_Member_Account_Credentials_Member_Security_String_Session			= $DB_Query_Kernel_Authenticate_Check_Member_Account_Credentials_Fetch_Array['member_security_string_session'];
...
*/
	...
	setcookie("kernel_member_security_string_session", "$DB_Query_Kernel_Authenticate_Check_Member_Account_Credentials_Member_Security_String_Session", time()+$_GLOBAL_SYSTEM_COOKIE_TIME);
...
/*
 ============================================================================================================
 + Member Account Authentication Log :: Write Authentication Attempt Data To Authentication Log
 ============================================================================================================
*/
...
/*
 ============================================================================================================
 + Dabatase Server Check: Member Account Entry Does Not Exist :: Redirect To No Known Registered Member Account Message
 ============================================================================================================
*/
...
/*
 ============================================================================================================
 + Kill Database Server Query: Check Member Account Entry
 ============================================================================================================
*/
...
*/
	...
	setcookie("kernel_member_security_string_session", "", time()-42000);
...
/*
 ============================================================================================================
 +
 + Internal Security :: Member Account :: Session :: Compare Current Session String In Cookie To Valid Session String In Database Server
 +
 ============================================================================================================
*/
...
$DB_Query_Kernel_Verify_String_Session_Find_Entry 						= $DB->query("SELECT * FROM {$_ACCESS_DATABASE_SERVER_DATABASE_TABLE_PREFIX}_members WHERE member_security_string_session='$_GLOBAL_COOKIE_MEMBER_SESSION' AND member_electronic_mail_address='$_GLOBAL_COOKIE_MEMBER_ELECTRONIC_MAIL_ADDRESS'");
$DB_Query_Kernel_Verify_String_Session_Check_Entry 						= $DB->num_rows($DB_Query_Kernel_Verify_String_Session_Find_Entry);

if ($DB_Query_Kernel_Verify_String_Session_Check_Entry >= 1) {
/**
 * Do Nothing
**/
} else {
...
} // [ + ] IF: Member Account Browser Cookie :: Session String Does Not Match Valid Session String In Database Server

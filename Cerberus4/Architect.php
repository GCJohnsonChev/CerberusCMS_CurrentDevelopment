...
echo ("
		...
		* <I>Pre-Hyper-Text-Post-Processor Engine Version Number</I>:<BR>
			<INPUT TYPE=\"TEXT\" NAME=\"post_php_engine_version\" VALUE=\"5\" MAXLENGTH=\"1\"><BR><BR>
		...
		* <I>Current Global System Database Server Class File For My Structured-Query-Language :: Improved Driver</I>:<BR>
		...
		[&nbsp;!&nbsp;]&nbsp;*Nix Server Users ( Linux, Unix, B.S.D., G.N.U., etc. ): Please refer to the $_PROJECT_STRING_NAME Architect Installation Manual for a complete list of file permissions that should be applied to each individual file.<BR><BR>
		...
		<B>Digital Information Security</B><HR>
...
mysql_query("INSERT INTO {$_ACCESS_DATABASE_SERVER_DATABASE_TABLE_PREFIX}_application_links(application_link_name,application_link_row,application_link_url)VALUES('Calculator','005','?Application_Member&#61;Calculator&amp;Display&#61;Options')");
mysql_query("INSERT INTO {$_ACCESS_DATABASE_SERVER_DATABASE_TABLE_PREFIX}_application_links(application_link_name,application_link_row,application_link_url)VALUES('Clock','006','?Application_Member&#61;Clock&amp;Display&#61;Default')");
...
mysql_query("INSERT INTO {$_ACCESS_DATABASE_SERVER_DATABASE_TABLE_PREFIX}_application_links(application_link_name,application_link_row,application_link_url)VALUES('Files','009','?Application_Member&#61;Files&amp;CategoryID&#61;All')");
mysql_query("INSERT INTO {$_ACCESS_DATABASE_SERVER_DATABASE_TABLE_PREFIX}_application_links(application_link_name,application_link_row,application_link_url)VALUES('Forum','010','?Application_Member&#61;Forum&amp;ForumID&#61;All')");
mysql_query("INSERT INTO {$_ACCESS_DATABASE_SERVER_DATABASE_TABLE_PREFIX}_application_links(application_link_name,application_link_row,application_link_url)VALUES('Language','011','?Application_Member&#61;Language')");
mysql_query("INSERT INTO {$_ACCESS_DATABASE_SERVER_DATABASE_TABLE_PREFIX}_application_links(application_link_name,application_link_row,application_link_url)VALUES('Lightning Calculate','012','?Application_Member&#61;Lightning_Calculate&amp;Display&#61;Options')");
mysql_query("INSERT INTO {$_ACCESS_DATABASE_SERVER_DATABASE_TABLE_PREFIX}_application_links(application_link_name,application_link_row,application_link_url)VALUES('Legal','013','?Application_Member&#61;Legal')");
mysql_query("INSERT INTO {$_ACCESS_DATABASE_SERVER_DATABASE_TABLE_PREFIX}_application_links(application_link_name,application_link_row,application_link_url)VALUES('Links','014','?Application_Member&#61;Links&amp;DisplayID&#61;All')");
mysql_query("INSERT INTO {$_ACCESS_DATABASE_SERVER_DATABASE_TABLE_PREFIX}_application_links(application_link_name,application_link_row,application_link_url)VALUES('Login','015','?Application_Member&#61;Login')");
mysql_query("INSERT INTO {$_ACCESS_DATABASE_SERVER_DATABASE_TABLE_PREFIX}_application_links(application_link_name,application_link_row,application_link_url)VALUES('Member Directory','016','?Application_Member&#61;Member_Directory')");
mysql_query("INSERT INTO {$_ACCESS_DATABASE_SERVER_DATABASE_TABLE_PREFIX}_application_links(application_link_name,application_link_row,application_link_url)VALUES('Messenger','017','?Application_Member&#61;Messenger&amp;Display&#61;MessengerOptions')");
mysql_query("INSERT INTO {$_ACCESS_DATABASE_SERVER_DATABASE_TABLE_PREFIX}_application_links(application_link_name,application_link_row,application_link_url)VALUES('News','018','?Application_Member&#61;News')");
mysql_query("INSERT INTO {$_ACCESS_DATABASE_SERVER_DATABASE_TABLE_PREFIX}_application_links(application_link_name,application_link_row,application_link_url)VALUES('Referrers','019','?Application_Member&#61;Referrers&amp;Display&#61;Box')");
mysql_query("INSERT INTO {$_ACCESS_DATABASE_SERVER_DATABASE_TABLE_PREFIX}_application_links(application_link_name,application_link_row,application_link_url)VALUES('RSS Feed','020','./RSS.php?')");
mysql_query("INSERT INTO {$_ACCESS_DATABASE_SERVER_DATABASE_TABLE_PREFIX}_application_links(application_link_name,application_link_row,application_link_url)VALUES('Register','021','?Application_Member&#61;Register')");
mysql_query("INSERT INTO {$_ACCESS_DATABASE_SERVER_DATABASE_TABLE_PREFIX}_application_links(application_link_name,application_link_row,application_link_url)VALUES('Search','022','?Application_Member&#61;Search')");
mysql_query("INSERT INTO {$_ACCESS_DATABASE_SERVER_DATABASE_TABLE_PREFIX}_application_links(application_link_name,application_link_row,application_link_url)VALUES('Statistics','023','?Application_Member&#61;Statistics')");
mysql_query("INSERT INTO {$_ACCESS_DATABASE_SERVER_DATABASE_TABLE_PREFIX}_application_links(application_link_name,application_link_row,application_link_url)VALUES('Submit Link','024','?Application_Member&#61;Links&amp;SubmitLink&#61;Yes')");
mysql_query("INSERT INTO {$_ACCESS_DATABASE_SERVER_DATABASE_TABLE_PREFIX}_application_links(application_link_name,application_link_row,application_link_url)VALUES('Submit News','025','?Application_Member&#61;Submit_News')");
mysql_query("INSERT INTO {$_ACCESS_DATABASE_SERVER_DATABASE_TABLE_PREFIX}_application_links(application_link_name,application_link_row,application_link_url)VALUES('Upload File','026','?Application_Member&#61;Upload')");
mysql_query("INSERT INTO {$_ACCESS_DATABASE_SERVER_DATABASE_TABLE_PREFIX}_application_links(application_link_name,application_link_row,application_link_url)VALUES('Video Player','027','?Application_Member&#61;Video_Player')");
mysql_query("INSERT INTO {$_ACCESS_DATABASE_SERVER_DATABASE_TABLE_PREFIX}_application_links(application_link_name,application_link_row,application_link_url)VALUES('Welcome !','028','?Application_Custom&#61;1')");
...
if (mail($_ACCESS_SYSTEM_ELECTRONIC_MAIL_ADDRESS,"$_PROJECT_STRING_NAME - Testing the Pre-Hyper-Text-Post-Processor Server mail() Function.","
-------This is a test to see if the Web Server Pre-Hyper-Text-Post-Processor mail() Function is working-------
...
")) {
	...
	echo ("<BIG><FONT COLOR=\"#CD0000\">***</FONT> Architect: Error: the Pre-Hyper-Text-Post-Processor Server mail() Function is not working. Correct this before using $_PROJECT_STRING_NAME.</BIG>");
